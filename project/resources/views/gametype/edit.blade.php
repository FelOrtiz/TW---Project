...
<div class="container">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="/gametype/index"><i class="fa fa-home"></i> Tipo Juego</a></li>
	...
	<section class="content">
		...
		<div class="box box-success">
			<div class="box-header with-border">
				<h3 class="box-title">Editar Tipo de Juego</h3>
			</div>
			<form method="POST" role="form" action="/gametype/update/{{ $gametype->id }}">
				{{ csrf_field() }}
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
